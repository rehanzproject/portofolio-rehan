...
export const listCard: ICardProject[] = [
  {
    name: "Tokopaedi",
    desc: "A mini e-commerce website for shoes, also known as a small-scale or simplified e-commerce website, is a platform that allows businesses or individuals to sell products or services online on a smaller scale. It typically offers a more compact and streamlined version of a full-scale e-commerce platform, with fewer features and a simpler interface.",
    techStack: [
      "React JS ",
      "TailwindCSS",
      "GraphQL",
